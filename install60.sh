...
# Mettre à jour les paquets et installer PHP 8.1 et les extensions requises
apt-get update
...
apt-get install -y php8.1-tokenizer php8.1-ctype php8.1-zlib php8.1-dom php8.1-simplexml php8.1-spl
apt-get install -y php8.1-pcre php8.1-xmlreader php8.1-intl php8.1-json php8.1-hash php8.1-fileinfo
apt-get install -y php8.1-sodium php8.1-exif
...
sed -i 's/.*file_uploads =.*/file_uploads = On/' /etc/php/8.1/apache2/php.ini
